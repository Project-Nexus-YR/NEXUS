...
DOCUMENTS: list[tuple[str, str]] = [
    (
        "corpus-01",
        "Ada Lovelace works at Acme Corp. Acme Corp is located in London. "
        "Acme Corp develops analytics software.",
    ),
    (
        "corpus-02",
        "Alan Turing works at Acme Corp. Acme Corp is headquartered in London. "
        "Alan Turing studied at Cambridge.",
    ),
    (
        "corpus-03",
        "Grace Hopper works at Initech. Initech is located in Menlo Park. "
        "Grace Hopper is a type of person.",
    ),
    (
        "corpus-04",
        "Nikola Tesla works at Umbrella Corp. Umbrella Corp is headquartered in Manhattan. "
        "Umbrella Corp develops quantum computing.",
    ),
    (
        "corpus-05",
        "Ada Lovelace studied at Cambridge. Marie Curie studied at Vienna. "
        "Marie Curie is a type of person.",
    ),
    (
        "corpus-06",
        "Acme Corp is a type of company. Sterling Labs is a type of company. "
        "Sterling Labs is located in London.",
    ),
    (
        "corpus-07",
        "Grace Hopper is a type of person. Alan Turing is a type of person. "
...
RETRIEVAL_QUERIES: list[tuple[str, list[str], list[str], list[tuple[str, str, str]]]] = [
    ...
    (
        "what does Umbrella Corp develop?",
        ["corpus-04"],
        ["umbrella corp"],
        [
            ("umbrella corp", "develops", "quantum computing"),
